...
class Liver(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.sub_head.setFont(QFont("Roboto", 24, weight=QFont.Bold))
        self.cover.setAlignment(Qt.AlignCenter)
        self.cover.setFont(QFont("Roboto", 24, weight=QFont.Bold))
        self.report_subhead = QLabel("About")
        self.details = QLabel(
            "Sistem ini dirancang menggunakan Algoritma C5.0 Classifier.\nDengan Hasil Akurasi: 76%\nData yang digunakan diambil dari website Kaggle dan UCI.")
    ...
    def report_ui(self):
        ...
        self.details.setFont(QFont("Arial", 13.9, weight=QFont.Bold))
    ...
    def test_input(self) -> None:
        ...
        self.model_details.setText(
            "Sistem ini dirancang menggunakan Algoritma C5.0 Classifier.\nDengan Hasil Akurasi: 76%\nData yang digunakan diambil dari website Kaggle dab UCI.")
        self.details.setText(

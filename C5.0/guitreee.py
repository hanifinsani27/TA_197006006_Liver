...
class Menu(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.fontpred.setFamily("Calibri")
        self.fontpred.setPointSize(10)
        self.btn_about.setFont(self.fontpred)
        self.btn_about.move(100, 70)
        self.about = QtGui.QIcon()
        self.about.addPixmap(QtGui.QPixmap("img/login.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_about.setIcon(self.about)
